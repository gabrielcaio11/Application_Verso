...
public class ReactionController {
  ...
  @Operation(
      ...
      description =
          "Adiciona uma nova reação ou atualiza a reação existente do usuário autenticado em um artigo publicado. Se o usuário já reagiu, a reação será atualizada.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
    ...
    @ApiResponse(
        responseCode = "422",
        description = "Apenas artigos publicados podem receber reações"),
  ...
  public ResponseEntity<Page<ReactionResponseDTO>> findAllReactionsByArticle(
    ...
    log.info(
        "Buscando reações para o artigo ID: {}. Página: {}, Tamanho: {}",
        articleId,
        pageable.getPageNumber(),
        pageable.getPageSize());
    var pageResponse = reactionService.findAllReactionsByArticle(articleId, pageable);
    log.info(
        "Total de reações encontradas para o artigo ID {}: {}",
        articleId,
  ...
  @Operation(
      ...
      description =
          "Retorna uma lista paginada de todas as reações feitas pelo usuário autenticado.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Lista de reações retornada com sucesso",
  ...
  @Operation(
      ...
      description =
          "Retorna estatísticas detalhadas das reações de um artigo, incluindo contagem por tipo e a reação do usuário autenticado.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retorna o tipo de reação do usuário autenticado em um artigo específico, ou null se não reagiu.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",

...
public class RolesController {
  ...
  @GetMapping
  public ResponseEntity<Page<RolesWithIdAndName>> getAll(@ParameterObject Pageable pageable) {
    log.info(
        "Buscando todos as roles. Página: {}, Tamanho: {}",
  ...
  @Operation(summary = "Buscar role por ID", description = "Retorna uma role específica.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<RolesWithIdAndName> getById(
      @Parameter(description = "ID da role", example = "1", required = true) @PathVariable
          Long id) {
  ...
  @Operation(summary = "Registro de nova role", description = "Cria um nova role.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<RolesWithIdAndName> update(
      @Parameter(description = "ID da role", example = "1", required = true) @PathVariable Long id,
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "403",
        description = "Acesso negado - apenas ADMIN pode deletar roles"),
    @ApiResponse(responseCode = "404", description = "Role não encontrada"),
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
  })
  @DeleteMapping("/{id}")

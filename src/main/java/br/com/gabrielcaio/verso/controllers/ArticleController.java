...
public class ArticleController {
  ...
  @Operation(
      ...
      description =
          "Creates a new article. Authenticated user will be set as author automatically.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "201",
  ...
  @Operation(
      ...
      description =
          "Retorna uma lista paginada de artigos com status PUBLICADO. Apenas artigos publicados são visíveis.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retorna uma lista paginada de artigos com status RASCUNHO do usuário autenticado. Apenas o autor pode ver seus próprios rascunhos.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retorna um artigo específico. Artigos PUBLICADOS podem ser visualizados por qualquer usuário autenticado. Artigos RASCUNHO só podem ser visualizados pelo autor.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        ...
        content =
            @Content(
                schema =
                    @Schema(
                        implementation = ArticleResponseWithTitleAndStatusAndCategoryName.class))),
    @ApiResponse(
        responseCode = "401",
        description = "Não autorizado",
        content = @Content(schema = @Schema(implementation = ErrorMessage.class))),
  ...
  @Operation(
      ...
      description =
          "Atualiza um artigo existente. Apenas o autor pode atualizar seus próprios artigos.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",

...
public class UserController {
  ...
  @Operation(
      ...
      description =
          "Retorna uma lista de todos os usernames cadastrados. Apenas usuários com perfil ADMIN podem acessar.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
    ...
    @ApiResponse(
        responseCode = "403",
        description = "Acesso negado - apenas ADMIN pode listar usuários"),
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
  })
  @Parameters({
    @Parameter(
  ...
  public ResponseEntity<Page<String>> findAll(@ParameterObject Pageable pageable) {
    log.info(
        "Buscando todos os usuários. Página: {}, Tamanho: {}",

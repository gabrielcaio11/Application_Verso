...
public class NotificationController {
  ...
  @Operation(
      ...
      description =
          "Retorna uma lista paginada de todas as notificações do usuário autenticado, ordenadas por data de criação (mais recentes primeiro).")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<Void> markAsRead(
      @Parameter(description = "ID da notificação", example = "1", required = true) @PathVariable
          Long notificationId) {

...
public class FavoriteController {
    ...
    @Operation(
            ...
            description = "Adiciona um artigo publicado aos favoritos do usuário autenticado. Apenas artigos publicados podem ser favoritados."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
            ...
            @ApiResponse(responseCode = "400", description = "Artigo não pode ser favoritado (não publicado)"),
    ...
    @Operation(
            ...
            description = "Retorna uma lista paginada de artigos favoritados pelo usuário autenticado. Apenas artigos publicados são retornados."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",

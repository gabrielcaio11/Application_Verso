...
public class CategoryController {
  ...
  public ResponseEntity<Page<CategoryResponseWithNameDTO>> findAll(
    ...
    log.info(
        "Buscando todas as categorias. Página: {}, Tamanho: {}",
  ...
  public ResponseEntity<CategoryResponseWithNameDTO> findById(
      @Parameter(description = "ID da categoria", example = "1", required = true) @PathVariable
          Long id) {
  ...
  @Operation(
      ...
      description =
          "Cria uma nova categoria. Apenas usuários com perfil ADMIN podem criar categorias.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
    ...
    @ApiResponse(
        responseCode = "422",
        description = "Erro de validação - nome de categoria já existe"),
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
  })
  ...
  @Operation(
      ...
      description =
          "Atualiza uma categoria existente. Apenas usuários com perfil ADMIN podem atualizar categorias.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Exclui uma categoria. Ao excluir, todos os artigos associados serão movidos para a categoria 'Sem categoria'. Apenas usuários com perfil ADMIN podem excluir categorias.")
  @ApiResponses({
    @ApiResponse(responseCode = "204", description = "Categoria deletada com sucesso"),
    @ApiResponse(responseCode = "401", description = "Não autorizado"),
    @ApiResponse(
        responseCode = "403",
        description = "Acesso negado - apenas ADMIN pode excluir categorias"),
    @ApiResponse(responseCode = "404", description = "Categoria não encontrada"),
    @ApiResponse(
        responseCode = "422",
        description = "Erro de validação - categoria padrão não pode ser excluída"),
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
  })
  @PreAuthorize("hasAuthority('ADMIN')")
  @DeleteMapping("/{id}")

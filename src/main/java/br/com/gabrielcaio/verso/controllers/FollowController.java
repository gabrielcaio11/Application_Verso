...
public class FollowController {
  ...
  @Operation(
      ...
      description =
          "Inicia o seguimento de um usuário. Você receberá notificações quando esse usuário publicar novos artigos.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Remove o seguimento de um usuário. Você não receberá mais notificações desse usuário.")
  @ApiResponses({
    @ApiResponse(responseCode = "204", description = "Usuário deixado de seguir com sucesso"),
    @ApiResponse(responseCode = "401", description = "Não autorizado"),
    @ApiResponse(
        responseCode = "404",
        description = "Usuário não encontrado ou você não está seguindo este usuário"),
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
  })
  ...
  @Operation(
      ...
      description =
          "Retorna uma lista paginada de usuários que o usuário autenticado está seguindo.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<Page<UserProfileDTO>> getFollowing(@ParameterObject Pageable pageable) {
    log.info(
  ...
  public ResponseEntity<Page<UserProfileDTO>> getFollowers(@ParameterObject Pageable pageable) {
    log.info(
  ...
  @Operation(
      ...
      description =
          "Retorna informações do perfil de um usuário, incluindo contagem de seguidores e se você está seguindo.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Status do seguimento retornado com sucesso"),
    @ApiResponse(responseCode = "401", description = "Não autorizado"),
    @ApiResponse(responseCode = "404", description = "Usuário não encontrado"),
    @ApiResponse(responseCode = "500", description = "Erro interno do servidor")
  })

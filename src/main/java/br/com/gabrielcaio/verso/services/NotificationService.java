...
public class NotificationService
{
    ...
    public void createNotificationForFollowers(Article article)
    {
        ...
        List<User> followers = followRepository
                .findFollowersByFollowing(author, Pageable.unpaged())
                .getContent();
    ...
    public Page<NotificationResponseDTO> getAllNotifications(Pageable pageable)
    {
        ...
        log.info("Buscando todas notificações do usuário id={} username={} page={} size={}",
                currentUser.getId(), currentUser.getUsername(), pageable.getPageNumber(),
    ...
    public Page<NotificationResponseDTO> getUnreadNotifications(Pageable pageable)
    {
        ...
        log.info(
                "Total de notificações não lidas encontradas: {}",
    ...
    public void markAllAsRead()
    {
        ...
        log.info(
                "Marcando todas as notificações como lidas para usuário id={}",
                currentUser.getId()
        );
        ...
        log.info(
                "Todas as notificações do usuário id={} foram marcadas como lidas",
                currentUser.getId()
        );
    }
    ...
    public void createNotificationForArticleComment(Article article, Comment comment)
    {
                        ...
                        .getId()))
        {
            ...
            log.info(
                    "Notificação criada para autor id={} (comentário recebido)",
                    article.getAuthor()
                            .getId()
            );
        }
    ...
    public void createNotificationForCommentReply(Comment parent, Comment reply)
    {
                        ...
                        .getId()))
        {
            ...
            log.info(
                    "Notificação criada para usuário id={} (resposta recebida)",
                    parent.getAuthor()
                            .getId()
            );
        }

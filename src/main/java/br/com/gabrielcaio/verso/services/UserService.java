...
public class UserService
{
    ...
    public User getCurrentUser()
    {
        ...
        return userRepository.findByUsername(username)
                ...
                {
                    log.warn(
                            "[UserService] Usuário autenticado '{}' não encontrado no banco",
                            username
                    );
    ...
    public void register(UserDTO dto)
    {
        ...
        log.info(
                "[UserService] Username gerado a partir do email '{}': {}", dto.getEmail(),
                usernameGerado
        );
    ...
    public Page<String> findAll(Pageable pageable)
    {
        ...
        log.info(
                "[UserService] Total de usuários retornados na página: {}",
    ...
    private void addRoles(User user, UserDTO dto)
    {
        ...
        roles.stream()
                ...
                {
                    log.info(
                            "[UserService] Atribuindo role '{}' ao usuário {}", roleName,
                            user.getUsername()
                    );

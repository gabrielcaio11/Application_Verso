...
public class ServiceLoggingAspect {
    ...
    /**
     * Intercepta todos os métodos públicos de todos os services.
     * Exemplo: ArticleService, UserService, CategoryService, etc.
     */
    ...
    private Object formatArguments(Object[] args) {
        ...
        if (hasId(first)) return "entity-id=" + extractId(first);
    ...
    private Object formatReturn(Object result) {
        ...
        if (hasId(result)) return "entity-id=" + extractId(result);
        return result;
    }
